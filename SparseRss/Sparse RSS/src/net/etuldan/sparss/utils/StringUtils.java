...
public class StringUtils {
    ...
    private static final DateFormat TIME_FORMAT = android.text.format.DateFormat.getTimeFormat(RSSOverview.INSTANCE);
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
            DATE_SHORT_FORMAT = new SimpleDateFormat(android.text.format.DateFormat.getBestDateTimePattern(RSSOverview.INSTANCE.getResources().getConfiguration().locale, "d MMM"));
        } else {
            DATE_SHORT_FORMAT = android.text.format.DateFormat.getDateFormat(RSSOverview.INSTANCE);
        }
    }
